...
ok my $formation = $formation_model->get_formation(10);
is $formation->id, 10;

ok my $formation_2 = $formation_model->get_formation_by_name('円陣');
is $formation_2->name, '円陣';
is $formation_2->description, '守備力+10%+5。彎月陣、鶴翼陣に強い。得意陣形の場合は更に守備力+10%。';

ok my $hou_jin = $formation_model->get_formation_by_name('方陣');
is $hou_jin->description, '攻撃力+10%。彎月陣、鶴翼陣に強い。得意陣形の場合は更に攻撃力+10%。';

ok my $gankou_jin = $formation_model->get_formation_by_name('雁行陣');
