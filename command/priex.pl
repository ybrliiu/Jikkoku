...
<font color=white>敵隣接都市に流言を放ち民忠を減らします。<br><font color="red">このコマンドを実行するにはバトルマップにでていて、更に指定した都市の城付近か、<br>指定した都市とその周囲の都市との間のMAP上にいる必要があります。</font><br>また、雇っている兵士数も下げる民忠に影響します。<br>金200必要です。</font>
</TD></TR></TABLE>
</TD></TR>
<TR><TD>
どの町にします？
...
<TABLE bgcolor= 00FFFF width=75% height=5 border="0" cellspacing=1><TBODY>
<TR><TH colspan= 11 bgcolor=00FFFF><font color=FFFFFF>$new_date</TH></TR>
          <TR>
