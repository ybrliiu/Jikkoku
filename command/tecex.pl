...
<font color=white>敵隣接都市の技術値を減らします。<br><font color="red">このコマンドを実行するにはバトルマップにでていて、更に指定した都市の城付近か、<br>指定した都市とその周囲の都市との間のMAP上にいる必要があります。</font><br>また、雇っている兵士数も下げる技術値に影響します。<br>金200必要です。</font>
</TD></TR></TABLE>
</TD></TR>
<TR><TD>
どの町にしますか？
...
print <<"EOM";
<BR>$znameから技術衰退が可能な街<BR>
$t_mes
$no_list
<input type=hidden name=mode value=43>

<input type=submit value=\"実行\">

<TR><TD width=75%>
<TABLE width=100%><TR><TD width=75%>
<TABLE bgcolor=CCFFFF width=75% height=5 border="0" cellspacing=1><TBODY>
<TR><TH colspan= 11 bgcolor=CCFFFF><font color=FFFFFF>$new_date</TH></TR>
          <TR>
