...
<font color=white>敵隣接都市の農業値を減らします。<br><font color="red">このコマンドを実行するにはバトルマップにでていて、更に指定した都市の城付近か、<br>指定した都市とその周囲の都市との間のMAP上にいる必要があります。</font><br>また、雇っている兵士数も下げる農業値に影響します。<br>金200必要です。</font>
</TD></TR></TABLE>
</TD></TR>
<TR><TD>
どの町にしますか
...
print <<"EOM";
<BR>$znameから農地破壊が可能な街<BR>
$t_mes
$no_list
<input type=hidden name=mode value=39>

<input type=submit value=\"実行\">

<TR><TD width=75%>
<TABLE width=100%><TR><TD width=75%>
<TABLE bgcolor=99FF00 width=75% height=5 border="0" cellspacing=1><TBODY>
<TR><TH colspan= 11 bgcolor=99FF00><font color=FFFFFF>$new_date</TH></TR>
          <TR>
