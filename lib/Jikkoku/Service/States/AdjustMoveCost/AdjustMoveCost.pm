package Jikkoku::Service::States::AdjustMoveCost::AdjustMoveCost {
  ...
  has 'available_states' => ( is => 'ro', isa => 'Jikkoku::Model::State::Result', lazy => 1, builder => '_build_available_states' );
  ...
  sub _build_states {
    my $self = shift;
    $self->available_states->get_move_cost_adjuster_states_with_result;
  }
