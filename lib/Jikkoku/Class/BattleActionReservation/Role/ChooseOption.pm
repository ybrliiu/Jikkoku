package Jikkoku::Class::BattleActionReservation::Role::ChooseOption {
  ...
  with 'Jikkoku::Class::BattleActionReservation::Role::Base';
  ...
  sub validator {
    my ($class, $args) = @_;
    my $validator = Jikkoku::Validator->new($args);
...
=head1 NAME
  ...
  Jikkoku::API::Command::Role::ChooseOption
...
=head1 DESCRIPTION
  ...
  package TestCommand {
    ...
    with 'Jikkoku::API::Command::Role::ChooseOption';
